            ...
            <div class="payment-methods">
                <div class="payment-method" data-bank="bca">
                    <div class="payment-logo">
                        <img src="assets/images/bca.png" alt="BCA" class="bank-logo">
                    </div>
                ...
                <div class="payment-method" data-bank="bni">
                    <div class="payment-logo">
                        <img src="assets/images/bni.png" alt="BNI" class="bank-logo">
                    </div>
                    <div class="payment-info">
    ...
    document.querySelectorAll('.payment-method').forEach(method => {
        method.addEventListener('click', function() {
            ...
            const bankInfo = {
                ...
                bni: { name: 'BNI', number: '9876-5432-1010' },
